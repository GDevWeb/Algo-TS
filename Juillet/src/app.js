...
function isAdmitted(argInputUser) {
    try {
        ...
        if (argInputUser >= 10) {
            return "Cher candidat, votre note est de : ".concat(argInputUser, " vous \u00EAtes admis");
        }
        else {
            return "Cher candidat, votre note est de : ".concat(argInputUser, " vous n'\u00EAtes pas admis");
        }
    }
    catch (error) {
        return error.message;
